...
// Sym stuff
export const PREVIEW_WIDGET_ID = 'forge_preview_search';
export const SEARCH_WIDGET_ID = 'forge_search_results';
export const HOMEHIGHLIGHTED_WIDGET_ID = 'forge_search_home_highlight_articles';
